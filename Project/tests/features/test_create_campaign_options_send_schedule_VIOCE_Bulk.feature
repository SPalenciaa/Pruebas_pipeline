@Test_Create_Campaign_Options_Send_Schedule_Voice_Bulk
Feature: Test_Create_Campaign_Options_Send_Schedule_Voice_Bulk

Background: 

    Given I am on the campaign settings page "Bulk Voice" in "Voice"

@Test_Create_Campaign_Options_Send_Schedule_Voice_Bulk_1 @smoke_test
...
@Test_Create_Campaign_Options_Send_Schedule_Voice_Bulk_2
...
@Test_Create_Campaign_Options_Send_Schedule_Voice_Bulk_3
Scenario: Create campaign with schedule option (error)

    Given I select a company, and a name for the test "PRUEBAS AUTOMATIZADAS"
    When I select Send now/schedule option "2"
    When I click on the "next" button to continue
    Then I see the error message "You need to properly schedule the campaign" in "//div[@class='ant-notification-notice-description']"

@Test_Create_Campaign_Options_Send_Schedule_Voice_Bulk_4
...
@Test_Create_Campaign_Options_Send_Schedule_Voice_Bulk_5
...
@Test_Create_Campaign_Options_Send_Schedule_Voice_Bulk_6 
Scenario: Create campaign with schedule option (error date )
    ...
    When I click on the "next" button to continue
    Then I see the error message "Every phase must have a configured date" in "(//div[@class='ant-notification-notice-description'])[1]"
    
@Test_Create_Campaign_Options_Send_Schedule_Voice_Bulk_7
