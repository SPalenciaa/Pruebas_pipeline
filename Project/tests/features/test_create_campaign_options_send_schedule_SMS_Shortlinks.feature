...
Feature: Test_Create_Campaign_Send_Schedule_Options_SMS_Shortlinks

Background: 

    Given I am on the campaign settings page "Shortlink" in "SMS"

@Test_Create_Campaign_Send_Schedule_Options_SMS_Shortlinks_1 @smoke_test
Scenario: Create campaign with send now option (error)
    ...
    Then I see the error message "The account is mandatory" in "//div[@class='ant-notification-notice-description']"

@Test_Create_Campaign_Send_Schedule_Options_SMS_Shortlinks_2 
...
@Test_Create_Campaign_Send_Schedule_Options_SMS_Shortlinks_3 
Scenario: Create campaign with schedule option (error)

    Given I select a company, and a name for the test "PRUEBAS AUTOMATIZADAS"
    When I select Send now/schedule option "2"
    When I click on the "next" button to continue
    Then I see the error message "You properly schedule each phase of the campaign" in "//div[@class='ant-notification-notice-description']"

@Test_Create_Campaign_Send_Schedule_Options_SMS_Shortlinks_4 
...
@Test_Create_Campaign_Send_Schedule_Options_SMS_Shortlinks_5 
...
@Test_Create_Campaign_Send_Schedule_Options_SMS_Shortlinks_6 
...
@Test_Create_Campaign_Send_Schedule_Options_SMS_Shortlinks_7 
