@Test_Upload_Csv_SMS_Shortlinks
Feature: Test_Upload_Csv_SMS_Shortlinks

Background: 

    Given I am on the content creation page "Shortlink" in "SMS"

@Test_Upload_Csv_SMS_Shortlinks_1
...
@Test_Upload_Csv_SMS_Shortlinks_2
...
@Test_Upload_Csv_SMS_Shortlinks_3 
